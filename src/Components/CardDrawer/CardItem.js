...
function SingleCard({ id,onRemove, name, price, image, quantity, onIncrease, onDecrease }) {
...
// function SingleCard({ id, name, price, image, quantity, onIncrease, onDecrease }) {
...
//                     <div className="flex justify-between items-center pb-3">
//                         <h3 className="font-sans text-base flex-1 truncate mr-2 capitalize font-bold">{name}</h3>
//                         <TiTimes color="#ccc" size={22} className="cursor-pointer" />
//                     </div>
//                     <div className="flex items-center justify-between">
//                         <p className='text-gray-600 text-base flex-1'>${price}</p>
                        
//                         <div className=' flex justify-between items-center'>
//                             <button className='bg-[#94634b] px-2 text-white rounded'>-</button>
//                             <span className="px-2">
//                               1
//                             </span>
//                             <button className='bg-[#94634b] px-2 text-white rounded'>
//                                 +
//                             </button>
//                         </div>
//                     </div>
