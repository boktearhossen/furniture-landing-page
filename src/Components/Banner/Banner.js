              ...
              <div className=' pr-2 pl-1 md:pl-0 md:w-[80%] w-full'>
                ...
                <div className='w-[95%] md:w-full'>
                  <form className='flex border border-black '>
                    <input className='text-black w-full px-3 bg-transparent focus:outline-none' type="text" name="seearch" placeholder='Search your product here...' />
                        ...
                        { 
                           BannerImgDes.one ? <>
                              <div className='absolute bottom-[150%] left-[50%] bg-white px-5 py-2 rounded w-60 shadow'>
                                <p className='text-gray-600'><b>Hello Boktear</b></p>
                                <p>This is me.</p>
                              </div>
                             </> : ""
                        }
